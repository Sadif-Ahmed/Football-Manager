...
public class TableViewClubMaxAgeController {
    ...
    public void load() throws Exception{
        ...
        List = PlayerInfoBeta.getObservablePlayerlsit(ClubSearch.Search_Club_Max_Age(club.getName(),club.Players));
        tableView.setEditable(true);
        tableView.setItems(List);
        if(ClubSearch.Search_Club_Max_Age(club.getName(),club.getPlayers()).size()==0)
        {
            Alert a = new Alert(Alert.AlertType.ERROR);
            a.setHeaderText("Club Maximum Age Window");
