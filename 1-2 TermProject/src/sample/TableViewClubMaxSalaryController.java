...
public class TableViewClubMaxSalaryController {
    ...
    public void load() throws Exception{
        ...
        List = PlayerInfoBeta.getObservablePlayerlsit(ClubSearch.Search_Club_Highest_Salary(club.getName(),club.Players));
        tableView.setEditable(true);
        tableView.setItems(List);
        if(ClubSearch.Search_Club_Highest_Salary(club.getName(), club.getPlayers()).size()==0)
        {
            Alert a = new Alert(Alert.AlertType.ERROR);
            a.setHeaderText("Club Maximum Salary Window");
